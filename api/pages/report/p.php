	...
	<div id="page-wrap">
		...
		<table id="meta" style="float:left">
                <tr>
                    ...
                    <td><textarea>SHUBH S. PATEL</textarea></td>
                </tr>
                <tr>

                    <td class="meta-head">PATIENT ID</td>
                    <td><textarea id="date">BL-2</textarea></td>
                </tr>
                <tr>
                    <td class="meta-head">REFERED BY</td>
                    <td><div class="due">SSSSSSS</div></td>
                </tr>
            ...
            <table id="meta">
                ...
                <tr>
                    ...
                    <td class="meta-head">Date of collection</td>
                    <td><textarea id="date">December 15, 2009</textarea></td>
                </tr>
                <tr>
                    <td class="meta-head">Date of reporting</td>
